export const EMAIL_TEMPLATE_VERIFICATION = `<!doctype html>
<html>
  <body>
    <div
      style="
          ...
          <tr style="width: 100%">
            <td>
              <h1
                ...
                ">
                TECHEXPO - CRM VERIFICATION
              </h1>
              <div style="color: #1a1a1a; font-weight: normal; text-align: center; padding: 16px 24px 16px 24px">
                To begin using our service, please enter the following one-time verification code at the sign-up portal
                - click the button below to redirected to the portal.
              </div>
              <h1
                style="
              ...
              <div style="text-align: center; padding: 0px 24px 16px 24px">
                <a
                  ...
                  ><span
                    ...
                    [endif]--></span
                  ><span>Sign-Up Verification Portal</span
                  ><span
                    ><!--[if mso
