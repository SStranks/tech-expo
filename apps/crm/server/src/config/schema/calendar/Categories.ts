...
export const CalendarCategoriesTable = pgTable(
  'calendar_event_categories',
  {
    ...
    clientGeneratedId: uuid('client_generated_id').unique().notNull().$type<CalendarCategoryClientGeneratedId>(),
...
export const insertCalendarCategoriesSchema = createInsertSchema(CalendarCategoriesTable)
  ...
  .transform((v) => ({
    ...
    clientGeneratedId: v.clientGeneratedId as CalendarCategoryClientGeneratedId,
  }));
