...
export const PipelineStagesTable = pgTable('pipeline_stages', {
  ...
  clientGeneratedId: uuid('client_generated_id').unique().notNull().$type<PipelineStageClientGeneratedId>(),
...
export const insertPipelineStagesSchema = createInsertSchema(PipelineStagesTable)
  ...
  .transform((v) => ({
    ...v,
    clientGeneratedId: v.clientGeneratedId as PipelineStageClientGeneratedId,
