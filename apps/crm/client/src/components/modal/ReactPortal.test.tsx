...
describe('Initialization', () => {
  describe('Render check', () => {
    test(`When no wrapper with matching Id is provided it should auto-generate its own wrapper instead`, () => {
    ...
    test('When wrapper with matching Id is provided it should render insider the provided wrapper', () => {
      // NOTE: Portal will render outside of RTL <div> container. This will be first div - should be empty.
      const { container } = render(
        <>
