    ...
    <FormModal portalActive={portalActive} setPortalActive={setPortalActive}>
      <FormProvider onSubmit={onSubmit}>
        ...
        <FormModal.Content>
          ...
          <FormProvider.Combo items={companiesList} rules={GENERIC_TEXT_RULES} name="companyTitle" label="Company" />
          <div className="">
          ...
          <FormProvider.Combo items={ownersList} rules={GENERIC_TEXT_RULES} name="dealOwner" label="Deal Owner" />
        </FormModal.Content>
        <FormModal.Footer>
