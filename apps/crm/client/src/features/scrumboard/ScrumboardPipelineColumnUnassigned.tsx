...
import { ScrumboardAddCard, ScrumboardPipelineCard, ScrumboardColumnAddBtn } from './index';
...
function ScrumboardPipelineColumnUnassigned(props: IScrumboardColumn): JSX.Element {
