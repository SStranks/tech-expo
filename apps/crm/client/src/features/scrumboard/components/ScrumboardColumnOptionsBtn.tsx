    ...
    <MenuTrigger>
      ...
      <Popover placement="bottom right" className={styles.scrumboardOptionBtn__popover}>
        <Menu className={styles.scrumboardOptionBtn__menu}>
          <MenuItem href={`pipeline/stage/update/${stageId}`} className={styles.scrumboardOptionBtn__menuItem}>
            <IconEye svgClass={styles.scrumboardOptionBtn__menuItem__svg} />
            <span>Edit Status</span>
          </MenuItem>
          <MenuItem href={`pipeline/stage/delete/${stageId}`} className={styles.scrumboardOptionBtn__menuItemWarning}>
            <IconDelete svgClass={styles.scrumboardOptionBtn__menuItemWarning__svg} />
            <span>Delete Status</span>
          </MenuItem>
          <MenuItem href={`pipeline/deals/delete/${stageId}`} className={styles.scrumboardOptionBtn__menuItemWarning}>
            <IconDelete svgClass={styles.scrumboardOptionBtn__menuItemWarning__svg} />
