...
export MONGO_USER=$(cat /run/secrets/mongo_user_service)
export MONGO_PASSWORD=$(cat /run/secrets/mongo_password_service)
export MONGO_DATABASE=$(cat /run/secrets/mongo_database)
export POSTGRES_PEPPER=$(cat /run/secrets/postgres_pepper)
export POSTGRES_USER=$(cat /run/secrets/postgres_user_service)
export POSTGRES_PASSWORD=$(cat /run/secrets/postgres_password_service)
